...
class NetCat:
    ...
    def listen(self):
        ...
        self.socket.listen(5) # Отложенных соединений должно быть не больше пяти
        while True:
            client_socket, _ = self.socket.accept() # Во второй переменной - инфа о сокете. Она нам не нужна.
...
if __name__ == '__main__':
    parser = argparse.ArgumentParser(
        ...
        echo 'ABC' | ./netcat.py -t 192.168.1.108 -p 135    # шлем текст на порт сервера 135
